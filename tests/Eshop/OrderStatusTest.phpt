...
use PrestaShop\PrestaShop\Core\{Employee\ContextEmployeeProviderInterface, Order\OrderStateDataProviderInterface};
...
class OrderStatusTest extends TestCase
{
	...
	{
		$orderStatus = new OrderStatus($order_state = Mockery::mock(OrderStateDataProviderInterface::class), $employee = Mockery::mock(ContextEmployeeProviderInterface::class));
