...
use BulkGate\{Plugin\Event\Helpers, Plugin\Event\Variables, Plugin\Strict, Plugin\Event\DataLoader, Plugin\Utils\Strings};
...
class Customer implements DataLoader
{
	...
	public function load(Variables $variables, array $parameters = []): void
	{
		...
		else if (isset($variables['customer_id'])) {
