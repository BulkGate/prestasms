...
use BulkGate\{
	...
	Plugin\User,
    PrestaSms\Database\ConnectionPrestashop,
...
class Factory implements DIFactory
{
	 ...
	 * @throws Exception
	 */
	public static function createContainer(array $parameters = []): Container
	{
		...
		// Database
		$container['database.connection'] = ['factory' => ConnectionPrestashop::class, 'parameters' => ['db' => $parameters['db']]];
